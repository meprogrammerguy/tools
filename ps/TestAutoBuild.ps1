...
#>
If (Test-Path \\al-csbuild-s04\build\COMMANDseries\COMMANDseriesBuild.old)
{
	Remove-Item \\al-csbuild-s04\build\COMMANDseries\COMMANDseriesBuild.old
}
...
If (Test-Path \\al-csbuild-s05\build\COMMANDseries\COMMANDseriesBuild.old)
{
	Remove-Item \\al-csbuild-s05\build\COMMANDseries\COMMANDseriesBuild.old
}
